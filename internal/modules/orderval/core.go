...
type Validator interface {
	Apply(o order.Order, res *order.Result)
}
...
func New(cfg Config) (Validator, error) {
	...
	return &validatorImpl{cfg: cfg}, nil
}

func (v *validatorImpl) Apply(o order.Order, res *order.Result) {
...
func (v *validatorImpl) checkOrderType(o order.Order, res *order.Result) {
	switch o.OrderType {
...
func (v *validatorImpl) checkQuantity(o order.Order, res *order.Result) {
...
func (v *validatorImpl) checkPrice(o order.Order, res *order.Result) {
...
func (v *validatorImpl) checkCustomerID(o order.Order, res *order.Result) {
	id := o.CustomerID
	if id == "" {
